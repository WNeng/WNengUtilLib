package com.android.wneng.widget;
...
public class CircleProgressView extends View
{
    ...
    private void parseAttributes(TypedArray a)
    {
        ...
        circleRadius = (int) a.getDimension(R.styleable.CircleProgressView_matProg_circleRadius, circleRadius);
        ...
        barSpinCycleTime = a.getInt(R.styleable.CircleProgressView_matProg_barSpinCycleTime, (int) barSpinCycleTime);
